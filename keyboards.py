...
def get_vpn_page_keyboard(keys, total: int, page: int = 1) -> InlineKeyboardMarkup:
    ...
    if total_pages > 1:
        nav_buttons = []
        if page > 1:
            nav_buttons.append(InlineKeyboardButton(text="◀️", callback_data=f"vpn_page_{page - 1}"))
...
def get_proxy_page_keyboard(proxies, total: int, page: int = 1) -> InlineKeyboardMarkup:
    ...
    if total_pages > 1:
        nav_buttons = []
        if page > 1:
            nav_buttons.append(InlineKeyboardButton(text="◀️", callback_data=f"proxy_page_{page - 1}"))
        nav_buttons.append(InlineKeyboardButton(text=f"{page}/{total_pages}", callback_data="noop"))
        if page < total_pages:
            nav_buttons.append(InlineKeyboardButton(text="▶️", callback_data=f"proxy_page_{page + 1}"))
        builder.row(*nav_buttons)
...
def get_admin_vpn_menu_keyboard() -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    builder.row(InlineKeyboardButton(text="➕ Добавить ключ", callback_data="admin_add_vpn"))
    builder.row(InlineKeyboardButton(text="❌ Удалить ключ", callback_data="admin_remove_vpn"))
    builder.row(InlineKeyboardButton(text="📋 Список ключей", callback_data="admin_list_vpn"))
...
def get_admin_sponsors_keyboard() -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    builder.row(InlineKeyboardButton(text="➕ Добавить", callback_data="admin_add_sponsor"))
    builder.row(InlineKeyboardButton(text="❌ Удалить", callback_data="admin_remove_sponsor"))
    builder.row(InlineKeyboardButton(text="📋 Список", callback_data="admin_list_sponsors"))
    builder.row(InlineKeyboardButton(text="🔙 Назад", callback_data="back_to_admin"))
    return builder.as_markup()
...
def get_admin_blacklist_keyboard() -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    builder.row(InlineKeyboardButton(text="➕ Добавить", callback_data="admin_blacklist_add"))
    builder.row(InlineKeyboardButton(text="❌ Удалить", callback_data="admin_blacklist_remove"))
    builder.row(InlineKeyboardButton(text="📋 Список", callback_data="admin_blacklist_list"))
    builder.row(InlineKeyboardButton(text="🔙 Назад", callback_data="back_to_admin"))
    return builder.as_markup()
...
def get_admin_broadcast_menu_keyboard() -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    builder.row(InlineKeyboardButton(text="📨 Всем", callback_data="admin_broadcast_all"))
    builder.row(InlineKeyboardButton(text="📩 Одному", callback_data="admin_broadcast_id"))
    builder.row(InlineKeyboardButton(text="🔙 Назад", callback_data="back_to_admin"))
    return builder.as_markup()
...
def get_support_reply_list_keyboard() -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    builder.row(InlineKeyboardButton(text="💬 Ответить (номер)", callback_data="admin_support_reply"))
...
def get_ad_reply_list_keyboard() -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    builder.row(InlineKeyboardButton(text="💬 Ответить (номер)", callback_data="admin_ad_reply"))
    builder.row(InlineKeyboardButton(text="🔙 Назад", callback_data="admin_support_menu"))
    return builder.as_markup()
